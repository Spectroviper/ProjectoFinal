...
@Composable
fun ChallengeInviteAcceptedChallengeItem(challengeInvite: ChallengeInvite, onClick: () -> Unit) {
    Card(
        ...
        Text(
            text = "The invite sent to ${challengeInvite.user?.userName} was accepted",
