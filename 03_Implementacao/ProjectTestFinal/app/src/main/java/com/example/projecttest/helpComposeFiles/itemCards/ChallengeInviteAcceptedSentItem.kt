...
@Composable
fun ChallengeInviteAcceptedSentItem(user: User, challengeInvite: ChallengeInvite, onClick: () -> Unit) {
    ...
    if (!challengeInvite.isRequest!!) {
        Card(
            ...
            Text(
                text = "The invite sent to ${user.userName} was accepted",
        ...
        Card(
            ...
            Text(
                text = "Later",//"The invite sent to ${challengeInvite..challengeName} was accepted",
                fontWeight = FontWeight.Bold,
                maxLines = 1,
                overflow = TextOverflow.Ellipsis
            )
