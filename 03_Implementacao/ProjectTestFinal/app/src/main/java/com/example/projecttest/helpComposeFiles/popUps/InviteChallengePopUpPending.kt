...
@Composable
fun InviteChallengePopUpPending(
    user: User,
    ...
    AlertDialog(
        ...
        title = {
            Text("Later",//"Do you accept this request from user ${user.userName} to join challenge ${challengeInvite.challenge.challengeName}?"
